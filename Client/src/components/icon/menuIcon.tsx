...
const MenuIcon = () => {
    return (
        <svg x="0px" y="0px" viewBox="0 0 512 512" style={{width: "25px",height: "25px"}} >
            <g>
                <g>
            ...
            <g>
                <g>
                    <path d="M501.333,245.333H10.667C4.779,245.333,0,250.112,0,256s4.779,10.667,10.667,10.667h490.667    c5.888,10.667-10.667S507.221,245.333,501.333,245.333z" />
                </g>
            </g>
            <g>
                <g>
